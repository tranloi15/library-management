...
public class BorrowService {
    ...
    public List<BorrowRecord> getActiveBorrowsByUser(Long userId) {
        return borrowRecordRepository.findByUserIdAndStatusOrderByBorrowDateDesc(userId, "BORROWING");
    }

    public List<BorrowRecord> getReturnedBorrowsByUser(Long userId) {
        return borrowRecordRepository.findByUserIdAndStatusOrderByBorrowDateDesc(userId, "RETURNED");
    }
